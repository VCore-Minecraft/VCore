...
public class KillPlayerUpdate extends Update {

    public UUID playerUUID;
    public KillPlayerUpdate(@NotNull UUID uuid) {
        super(uuid);
    }
    ...
    public UpdateCompletion onInstructionReceive(MessagingService messagingService) {
        ...
        return UpdateCompletion.fromBoolean(gameServerPlatform.killPlayer(playerUUID).join());
    }
}
